...
@Service
public class LC extends AbstractRendaFixaCroller {

    @Override
    public void process() {
        try {
            final ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://rendafixa-lightlemon.rhcloud.com/api/vx/get_investment/lc/", String.class);
