...
@Service
public class DPGE extends AbstractRendaFixaCroller {

    @Override
    public void process() {
        try {
            final ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://rendafixa-lightlemon.rhcloud.com/api/vx/get_investment/dpge/", String.class);
